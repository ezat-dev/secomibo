...
.box1 input {
    ...
    <div class="button-container">
        <button class="select-button" onclick="getShortSiljukList();">
...
<script>
	...
	function getShortSiljukList(){
		...
		userTable = new Tabulator("#tab1", {
		    ...
		    headerHozAlign:"center",
		     ajaxConfig:"POST",
		    ajaxLoader:false,
		    ajaxURL:"/tkheat/process/shortSiljuk/getShortSiljukList",
	...
	$(".excel-button").click(function () {
	    ...
	    const filename = "쇼트/샌딩작업실적_" + today + ".xlsx";
	    userTable.download("xlsx", filename, { sheetName: "쇼트샌딩작업실적" });
	});
